...
#ifndef FOUR_C_BEAMINTERACTION_CONTACT_SUBMODEL_EVALUATOR_ASSEMBLY_MANAGER_DIRECT_HPP
#define FOUR_C_BEAMINTERACTION_CONTACT_SUBMODEL_EVALUATOR_ASSEMBLY_MANAGER_DIRECT_HPP
